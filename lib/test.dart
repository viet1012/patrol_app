                  ...
                  child: RawAutocomplete<AutoCmp>(
                    ...
                    onSelected: (AutoCmp selection) {
                      ...
                      _counterController.text =
                          selection.countermeasure; // <-- MẤU CHỐT LÀ ĐÂY
                    ...
                    fieldViewBuilder:
                        (context, controller, focusNode, onFieldSubmitted) {
                          return TextField(
                            controller:
                                controller, // Đây chính là _commentController
                            focusNode: focusNode,
                            maxLines: 2,
                            decoration: InputDecoration(
                              hintText:
                                  "Nhập Comment...", // "commentHint".tr(context)
                              filled: true,
                  ...
                  child: RawAutocomplete<AutoCmp>(
                    ...
                    fieldViewBuilder:
                        (context, controller, focusNode, onFieldSubmitted) {
                          return TextField(
                            controller:
                                controller, // Đây chính là _counterController
                            focusNode: focusNode,
                            maxLines: 2,
                            decoration: InputDecoration(
                              hintText:
                                  "Nhập đối sách...", // "counterMeasureHint".tr(context)
                              filled: true,
                              fillColor: Colors.yellow.shade50,
                              border: OutlineInputBorder(
                                borderRadius: BorderRadius.circular(12),
