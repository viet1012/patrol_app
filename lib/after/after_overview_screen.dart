...
import 'after_report_list_screen.dart';

class AfterOverviewScreen extends StatefulWidget {
  ...
  @override
  State<AfterOverviewScreen> createState() => _AfterOverviewScreenState();
}

class _AfterOverviewScreenState extends State<AfterOverviewScreen> {
            ...
            onTap: isTotal
                ...
                : () async {
                    ...
                    final result = await Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (_) => AfterReportListScreen(
